...
public class TangerinePop extends HotDogIngredient {
private BufferedImage img;
	
	public TangerinePop(HotDog hotDog) {
		super(hotDog);
		try {
			img = ImageIO.read(this.getClass().getResource("/img/drinks/Tangerine.png"));
		}catch(IOException e) {
